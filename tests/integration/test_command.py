...
# =================================================================================================
# No additional constants needed for command test
...
def main() -> int:
    ...
    # Create your queues
    input_queue = queue_proxy_wrapper.QueueProxyWrapper(mp_manager, 50)
    output_queue = queue_proxy_wrapper.QueueProxyWrapper(mp_manager, 50)
